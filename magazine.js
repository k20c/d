...
var MagazineView = {
    ...
    maxScale: 2,
    init: function () {
        $('#toolbarViewerRight').prepend('<button id="m" class="toolbarButton m hiddenLargeView" title="Switch to Magazine Mode" tabindex="99" data-l10n-id="magazine_mode"><span data-l10n-id="magazine_mode_label">Magazine Mode</span></button>');
        ...
        $('#secondaryToolbarButtonContainer').prepend('<button id="secondarym" class="secondaryToolbarButton m visibleLargeView" title="Switch to Magazine Mode" tabindex="51" data-l10n-id="magazine_mode"><span data-l10n-id="magazine_mode_label">Magazine Mode</span></button>');

        $(document).on('click', '#m,#exitMagazineView', function (e) {
        ...
        $(document).on('click', '#secondarym', function (e) {
		...
		if(window.location.hash.indexOf('m=true') == -1)
        {
			document.addEventListener("pagesloaded", MagazineView.launchm, true);
        }
    },
	launchm: function(e){
		document.removeEventListener("pagesloaded", MagazineView.launchm, true);
		$('#m').click();
	},
